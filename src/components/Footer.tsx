...
const Footer = () => {
  ...
  return (
    <FooterContainer>
      <FooterContent>
        ...
        >
          <FooterSection>
            ...
            <motion.p variants={itemVariants} style={{ color: 'rgba(255, 255, 255, 0.8)', lineHeight: '1.6' }}>
              Développeur passionné créant des expériences numériques exceptionnelles avec des technologies modernes.
            </motion.p>
      ...
      <Copyright>
        &copy; {currentYear} Nivo Rakoto. Tous droits réservés.
      </Copyright>
    </FooterContainer>
  );
};
